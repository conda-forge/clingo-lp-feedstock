...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/clingo-lp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14614&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clingo-lp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `clingo-lp` can be installed with:

```
conda install clingo-lp
```

It is possible to list all of the versions of `clingo-lp` available on your platform with:
